...
st.write("""Visualisai ini menyajikan hasil olahan data terkait penyewaan sepeda berdasarkan suhu, cuaca, hari kerja, dan akhir pekan. Data ini diambil dari dataset `day.csv` dan `hour.csv` yang berisi informasi cuaca, tanggal, berapa orang yang meminjam sepeda, dan lain sebagainya.""")
...
st.write("""
**Insight:** 
- Terdapat tren penyewaan sepeda yang bervariasi setiap bulannya, dengan beberapa bulan menunjukkan puncak yang signifikan, yaitu pada bulan Mei dan juga September.
""")
...
st.write("""
**Insight:** 
- Terlihat bahwa sebaran dari suhu pada data set ini tidak dapat terlihat jelas apakah sebarannya normal atau kah miring ke kiri atau kanan.
...
# 6. subheader("Matriks Korelasi antara Variabel")
